...
body{
    background-image:url(https://media.istockphoto.com/id/1313359908/photo/book-shelf.jpg?b=1&s=170667a&w=0&k=20&c=RPyI3xRfP4GyKFPxnMzKL7nkHynw5wxTJip1odjD-S4=);
    display:block;
    background-size: 100%;
...
?>
            ...
            <p ><u>Book Name:</u>&nbsp;;&nbsp;<?php echo $bookname ?></p>
            <p ><u>Book Detail:</u>&nbsp;;&nbsp;<?php echo $bookdetail ?></p>
            <p ><u>Book Authour:</u>&nbsp;;&nbsp;<?php echo $bookauthour ?></p>
            <p ><u>Book Publisher:</u>&nbsp;;&nbsp;<?php echo $bookpub ?></p>
            <p ><u>Book Branch:</u>&nbsp;;&nbsp;<?php echo $branch ?></p>
            <p ><u>Book Price:</u>&nbsp;;&nbsp;<?php echo $bookprice ?></p>
            <p ><u>Book Available:</u>&nbsp;;&nbsp;<?php echo $bookava ?></p>
            <p ><u>Book Rent:</u>&nbsp;&nbsp;<?php echo $bookrent ?></p>
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[9]</td>";
                $table.="<td>$row[10]</td>";
                $table.="<td><a href='admin_service_dashboard.php?viewid=$row[0]'><button type='button' class='btn btn-dark'>View BOOK</button></a></td>";
                // $table.="<td><a href='deletebook_dashboard.php?deletebookid=$row[0]'>Delete</a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
